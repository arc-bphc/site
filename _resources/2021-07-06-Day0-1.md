...
<h4><details>
  ...
  Yes, you can get the kit delvered to you in time (3-4 days) using the express delivery option. Note that the express delivery will cost you an aditional 200 rupees.
</details></h4>  
